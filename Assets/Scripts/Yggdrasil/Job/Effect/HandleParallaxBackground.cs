...
namespace Yggdrasil.Job.Effect
{
    /**
     * <summary>
     * Handle the parallax background effect
     * </summary>
     */
    [Serializable]
    public class HandleParallaxBackground : IJob
    {
        # region Properties
        ...
        {
            _data                    = controller.GetData<ParallaxBackground>();
